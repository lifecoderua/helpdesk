...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    #
    primary.item :fresh, 'New', display_tickets_path(Status.displays[:fresh])
    primary.item :open, 'Open', display_tickets_path(Status.displays[:open])
    primary.item :hold, 'On Hold', display_tickets_path(Status.displays[:hold])
    primary.item :closed, 'Closed', display_tickets_path(Status.displays[:closed])
